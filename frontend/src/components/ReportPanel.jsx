...
export default function ReportPanel() {
  ...
  return (
    <div className={`rounded-xl border overflow-hidden ${
      isEmergency ? 'border-red-700/50' : 'border-gray-700/50'
    } bg-gray-900/60`}>
      {/* Cabecera */}
        ...
        {latestReport ? (
          <>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className={`text-xs font-mono ${isEmergency ? 'text-red-500' : 'text-gray-600'}`}>
            ...
            <pre className={`text-xs whitespace-pre-wrap font-mono leading-relaxed max-h-52 overflow-y-auto ${
              isEmergency ? 'text-red-200' : 'text-gray-300'
            }`}>
          ...
          <div className="text-center py-4">
            <p className="text-gray-600 text-sm">Sin reportes generados.</p>
